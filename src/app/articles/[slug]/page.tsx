  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 py-10 text-slate-900">
      ...
      <article>
              ...
              if (seg === "[CTA-BOUTIQUE]") {
                return (
                  ...
                  >
                    <div className="bg-white rounded-[22px] p-4 flex flex-col md:flex-row items-center gap-6 border border-slate-50">
                      <div className="w-full md:w-40 aspect-video md:aspect-square rounded-xl overflow-hidden shrink-0 relative">
                        <Image src="/guide.jpg" alt="Guides cliniques" fill className="object-cover" sizes="(min-width:768px) 160px, 100vw" />
                      </div>
                      <div className="flex-1 text-center md:text-left">
        ...
        {relatedPosts.length > 0 && (
          <section className="max-w-7xl mx-auto mt-20 mb-16">
            <div className="text-center mb-10">
              <h2 className="text-[10px] font-bold uppercase tracking-[0.4em] text-blue-600 mb-3 font-sans">Poursuivre la lecture</h2>
              <p className="text-3xl md:text-4xl font-serif italic text-slate-900">À lire ensuite</p>
            </div>
        ...
        <footer className="max-w-7xl mx-auto mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20 text-white">
