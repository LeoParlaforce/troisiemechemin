    ...
    <main className="min-h-screen bg-transparent">
      ...
      <section className="mx-auto max-w-6xl px-6 py-14">
        <header className="mb-16">
          <h1 className="font-serif text-5xl md:text-6xl font-bold text-slate-900 italic tracking-tighter">Boutique.</h1>
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {sortedProducts.map((p) => {
            ...
            if (p.slug === "hauts-potentiels" || p.slug === "haut-potentiel-intellectuel") {
              productImage = "/hpi.jpg"
            }

            const finalImage = productImage || "/placeholder.jpg"
