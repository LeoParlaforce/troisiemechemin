        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            },
            {
              ...
              desc: "Un cas qui vous occupe, une séance qui vous laisse perplexe, une question clinique. Autant de fois que vous voulez, quand vous voulez.",
            },
            {
              n: "03",
            ...
            },
            {
              ...
              desc: "Vous répondez, je réponds. Jour après jour, cet échange continu constitue la supervision.",
            },
          ].map((item, i) => (
