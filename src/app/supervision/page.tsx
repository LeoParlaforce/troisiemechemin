...
export default function SupervisionPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Parce que la supervision écrite force à formuler. Présenter un cas par écrit oblige à le construire, à choisir ce qu'on met en avant, à entendre ce qu'on dit. C'est déjà un travail clinique en soi. Et tout reste : vous gardez la trace de vos propres élaborations.",
    },
    {
      q: "Quelle orientation théorique ?",
      a: "Psychanalyse lacanienne. Mais la supervision ne consiste pas à imposer un cadre — elle vous aide à penser le vôtre, avec ses propres références, dans sa propre cohérence. On travaille avec ce que vous apportez.",
    },
    {
      q: "C'est pour qui ?",
      a: "Pour les psychologues, psychanalystes, psychothérapeutes en exercice. Pour les praticiens en formation. Pour les étudiants qui commencent à recevoir et qui veulent un cadre régulier pour penser ce qui se joue.",
    },
    {
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-600 italic text-sm leading-relaxed">
                Tout reste consigné. Vous relisez vos propres formulations, vous voyez votre cadre se construire dans le temps.
              </p>
            </div>
          </div>
        </div>
